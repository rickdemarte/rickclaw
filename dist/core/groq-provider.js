...
class GroqProvider {
    ...
    constructor(tier = 'default') {
        this.ai = new groq_sdk_1.default({ apiKey: process.env.GROQ_API_KEY });
    ...
    extractFallbackToolCall(content) {
        ...
        if (rawJsonArgs && typeof rawJsonArgs.name === 'string') {
            const args = typeof rawJsonArgs.arguments === 'object' && rawJsonArgs.arguments !== null
